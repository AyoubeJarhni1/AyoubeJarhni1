# 👋 Hi, I'm Ayoub Jarhni  
🎓 **Software Engineering Student** in the 2nd year at **ENSA Khouribga**.  
💻 Passionate about **Web & Mobile Development**, **DevOps**, and **System Administration**.  
🚀 Always eager to learn new technologies and work in a collaborative environment.
...
- **Project Management** : Agile (Scrum), Jira, MVC  
...
### 🏆 **3D SMART FACTORY** *(Jul. 2024 – Sep. 2024, Mohammedia)*  
> **Topic**: "A web application for dental domain processing"  
- **Technologies**: UML, Figma, Next.js, Three.js, Django, Git  

### 🚗 **Car Rental Web App**  
🔹 **Tech**: ReactJs, Spring Boot, Spring Security, MySQL  
- Manage car rentals, bookings, and user authentication  

### 📖 **Course & Tutoring Management App**  
🔹 **Tech**: PHP, MySQL, CSS, HTML  
- Students register for courses and track their progress  

### 📌 **Task Management App for Professors**  
🔹 **Tech**: Java, MongoDB, SWING, MVC, Google Auth  
- Manage academic tasks and assignments  

### 🍽️ **Restaurant Management Web App**  
🔹 **Tech**: PHP, ReactJS, MySQL  
- Online food ordering system with admin panel  
...
⭐️ **Feel free to explore my work and contribute!** 🚀
